  ...
  let n = {
              ...
              success: function (t) {
                s.replaceWith(t),
                  i
                    ...
                    .removeAttr("style"),
                  n.find(".elementor-element").each(function () {
            ...
            renderCustom: (e, t, n) => {
              ...
              for (let e = 1; e <= n; e++)
                i +=
                  ...
                  (t === e
                    ? " swiper-pagination-bullet-active slick-active"
                    : "swiper-pagination-bullet") +
                  '"><button type="button" role="tab"  tabindex="0" aria-selected="true" class="">' +
                  e +
                  "</button></li>";
              return i;
            },
    ...
    Piechart: function (t) {
      var n = t.find(".colorful-chart"),
        i = n.data(),
        s = { barColor: i.color, lineWidth: i.linewidth, trackColor: i.barbg };
          ...
          barColor:
            !0 === n.gradientChart
              ? function (e) {
                  ...
                  return (
                    s.addColorStop(0, n.gradientColor1),
